...
{   
	...
	var position_1 = (document.documentElement.clientWidth-381)/2+document.documentElement.scrollLeft;
	var position_2 = (document.documentElement.clientHeight-159)/2+document.documentElement.scrollTop; 
	popupDivHtml = '<div class="zixun0704" id="kfpopupDiv" onmousedown="MyMove.Move(\'kfpopupDiv\',event,1);"  style="z-index:10000; position: absolute; top: '+position_2+'px; left: '+position_1+'px;color:#000;font-size: 12px;cursor:move;height: 159px;width: 381px;">';
  	popupDivHtml += kf_getPopupDivHtml(kfguin,ws,companyname,welcomeword, wpadomain);
  	popupDivHtml += '</div>';
	if(document.documentElement.insertAdjacentHTML)
	{
  		document.documentElement.insertAdjacentHTML("beforeEnd",popupDivHtml);
	}
	else
	{
...
{ 
 	...
 	{    
	      ...
	      document.onmousemove = function(e)
	      {
	        	...
	        	var bh = Math.max(document.documentElement.scrollHeight,document.documentElement.clientHeight,document.documentElement.offsetHeight,
	        						document.documentElement.scrollHeight,document.documentElement.clientHeight,document.documentElement.offsetHeight);
	        	var bw = Math.max(document.documentElement.scrollWidth,document.documentElement.clientWidth,document.documentElement.offsetWidth,
	        						document.documentElement.scrollWidth,document.documentElement.clientWidth,document.documentElement.offsetWidth);
	        	var sbw = 0;
	        	if(document.documentElement.scrollWidth < bw)
 		  ...
 		  {       
 		   	   ...
 		   	   if(!o1) 
			   {
			      return; 
 		   	   ...
 		   	   jdocument.documentElement.removeChild(o);       
 		   	   o = null;      
 		}  
 	}  
